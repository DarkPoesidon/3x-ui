...
update() {
    ...
    bash <(curl -Ls https://raw.githubusercontent.com/DarkPoesidon/3x-ui/main/update.sh)
    if [[ $? == 0 ]]; then
...
update_dev() {
    ...
    XUI_UPDATE_TAG="dev-latest" bash <(curl -Ls https://raw.githubusercontent.com/DarkPoesidon/3x-ui/main/update.sh)
    if [[ $? == 0 ]]; then
...
update_menu() {
    ...
    if replace_xui_script "https://raw.githubusercontent.com/DarkPoesidon/3x-ui/main/x-ui.sh" "false"; then
...
update_shell() {
    if replace_xui_script "https://github.com/DarkPoesidon/3x-ui/raw/main/x-ui.sh" "true"; then
